...
class CadastroLancamento extends React.Component {
    ...
    atualizar = () => {
        ...
        const { descricao, valor, mes, ano, tipo, id, idUsuario, status } = this.state;
        const lancamento = { descricao, valor, mes, ano, tipo, id, idUsuario, status };
        ...
        return (
          <Card title={ this.state.atualizando ? 'Atualização de lançamento.' : 'Cadastro de lançamento'}>
              ...
              <div className="row">
                  ...
                  <div className="col-md-4" >
                      <FormGroup id="inputMeses" label="Status: *" >
                          <input type="text" 
                                 name="status"
                 ...
                 <div className="col-md-6">
                     {
                         ...
                         ( 
                          <button onClick={this.atualizar} className="btn btn-success" title="Atualizar">                              
